	...
	class A3ReduxAll
	{
		class WEST
		{
			...
			class Vehicles
			{
				...
				class B_APC_Tracked_01_AA_F					{cost = 6000;	requirements[]={};	};	// "IFV-6a Cheetah"
				class B_AFV_Wheeled_01_cannon_F				{cost = 4500;	requirements[]={};	};	// "Rhino MGS"
				class B_AFV_Wheeled_01_up_cannon_F			{cost = 5000;	requirements[]={};	};	// "Rhino MGS UP" 
			...
			class Gear
			{
				class Box_NATO_Ammo_F						{cost = 100;		requirements[]={};	};	// "Basic Ammo [NATO]"
				class Box_NATO_Grenades_F					{cost = 100;		requirements[]={};	};	// "Grenades [NATO]"
		...
		class EAST
		{
			...
			class Gear
			{
				class Box_East_Ammo_F						{cost = 100;		requirements[]={};	};	// "Basic Ammo [CSAT]"
				class Box_East_Grenades_F					{cost = 100;		requirements[]={};	};	// "Grenades [CSAT]"
